...
class VoucherController extends Controller
{
    public function index()
    {
        ...
        return view('views.admin.vouchers.index', compact('vouchers', 'title'));
    }

    public function create()
    {
        $title = 'Thêm voucher';
        return view('views.admin.vouchers.create', compact('title'));
    }
    ...
    {
        $title = 'Sửa voucher';
        return view('views.admin.vouchers.edit', compact('voucher', 'title'));
    }
