...
class ColorService 
{
    ...
    public function store(StoreCommonRequest $request)
    {
        try {
            ...
            return response()->redirectToRoute('admin.colors_index')->with('success', TextSystemConst::CREATE_SUCCESS);
        } catch (Exception $e) {
            Log::error($e);
            return response()->redirectToRoute('admin.colors_index')->with('error', TextSystemConst::CREATE_FAILED);
        }
    }
