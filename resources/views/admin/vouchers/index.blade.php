                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3">
                        <div
                            ...
                            <a href="{{ route('admin.vouchers_create') }}" class="btn btn-primary text-capitalize me-4">Thêm
                                mới</a>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a style="display:inline-block";
                                                    href="{{ route('admin.vouchers_edit', $voucher->id) }}"
                                                    class="btn btn-warning btn-sm">Sửa</a>
                                                <form action="{{ route('admin.vouchers_delete', $voucher->id) }}"
